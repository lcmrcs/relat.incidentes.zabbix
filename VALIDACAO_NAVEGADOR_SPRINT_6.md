...
- Data: 2026-07-27T13:59:49-03:00
...
- Impressão nativa: aprovada (8889.1 KB).

| Registros | Execuções | Resultado | HTML | DOM inicial | Carregamento | Busca | Filtro | Página | Ordenação |
| ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 1 | Aprovado | 1.80 MB | 414 | 365.4 ms | 0.0 ms | 0.0 ms | 0.0 ms | 0.0 ms |
| 10 | 1 | Aprovado | 1.86 MB | 1173 | 439.0 ms | 180.0 ms | 0.0 ms | 0.0 ms | 0.0 ms |
| 7,171 | 3 | Aprovado | 3.77 MB | 2441 | 591.4 ms | 180.0 ms | 0.0 ms | 10.0 ms | 0.0 ms |
| 20,000 | 1 | Aprovado | 6.80 MB | 2441 | 600.4 ms | 180.0 ms | 0.0 ms | 9.9 ms | 0.0 ms |
